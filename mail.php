...
function enviarCorreoVerificacion($email, $nombre, $token, $codigo_verificacion  ) {
    ...
    try {
        ...
        <body>
            <div class="container">
                ...
                <p>' . $url . '</p>
                <p>Después de hacer clic en el enlace, necesitarás ingresar este código de verificación de 6 dígitos:</p>
                <div class="code">' . $codigo_verificacion . '</div>
                <p>Si no has solicitado esta cuenta, puedes ignorar este correo.</p>
                <div class="footer">
                    <p>Saludos,<br>BOL200</p>
        ...
        $mail->AltBody = 'Hola ' . $nombre . ', gracias por registrarte. Para verificar tu cuenta, visita: ' . $url. ' y usa el código de verificación: ' . $codigo_verificacion;
...
function enviarCorreoRecuperacion($email, $mensaje, $asunto) {
    $mail = new PHPMailer(true);
